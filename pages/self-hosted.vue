  ...
  <div class="mt-8">
    ...
    <div class="flex justify-center">
      <div class="flex flex-col items-center">
        ...
        <NuxtLink class="text-blue-400 underline"  to="https://country-state-city.net/" target="_blank">Country-State-City API</NuxtLink>
        <p class="text-amber-300">Feel free to use these systems, but please don't abuse them.</p>
      </div>
    </div>
  </div>
</template>
